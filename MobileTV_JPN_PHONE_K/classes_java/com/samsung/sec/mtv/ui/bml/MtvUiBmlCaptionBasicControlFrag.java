    ...
    implements android.view.View.OnClickListener, android.view.View.OnLongClickListener, android.view.View.OnTouchListener
{
    ...
    public MtvUiBmlCaptionBasicControlFrag()
    {
        ...
        mRunnableBMLCtrlUp = new Runnable() {
            ...
            public void run()
            {
                if(MtvUiBmlCaptionBasicControlFrag.mBmlApp != null)
                    MtvUiBmlCaptionBasicControlFrag.mBmlApp.onKeyEvent(new KeyEvent(0, 19));
                if(mHandler != null)
...
;
        mRunnableBMLCtrlDown = new Runnable() {
            ...
            {
                if(MtvUiBmlCaptionBasicControlFrag.mBmlApp != null)
                    MtvUiBmlCaptionBasicControlFrag.mBmlApp.onKeyEvent(new KeyEvent(0, 20));
                if(mHandler != null)
...
;
    ...
    public static void hide()
    {
        if(mFragHandler != null)
            mFragHandler.removeFrag(com.samsung.sec.mtv.ui.common.MtvUiFragHandler.FRAG_TYPE.TYPE_BMLCAPBASIC);
    }
    ...
    {
        if(mFragHandler != null)
            mFragHandler.addFrag(com.samsung.sec.mtv.ui.common.MtvUiFragHandler.FRAG_TYPE.TYPE_BMLCAPBASIC, -1L, false, new int[0]);
    }
    ...
    {
        mCntrlFragView = layoutinflater.inflate(0x7f03001e, viewgroup, false);
        init();
...
_L6:
    ...
    private static final String TAG = "MtvUiBmlCaptionBasicControlFrag";
